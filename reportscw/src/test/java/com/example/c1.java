...
public class c1 {
    ...
    public void setup()
    {
        ExtentSparkReporter sparkReporter = new ExtentSparkReporter("C:\\Users\\Bhoomika Devarajan\\Desktop\\Stesting.html");
    ...
    public void tearDown(ITestResult result)throws Exception
    {
        if(result.getStatus()==ITestResult.FAILURE)
        {
            ...
            String screenShotPath = "C:\\Users\\Bhoomika Devarajan\\Desktop\\Stesting"+result.getName()+".png";
